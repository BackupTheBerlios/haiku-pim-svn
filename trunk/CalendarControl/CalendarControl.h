...
#include "../PreferencesMessage/PreferencesMessage.h"
...
public:	
	...
	void ParsePreferences(const BMessage* in);
	void MessageReceived( BMessage* in);
	void AttachedToWindow();
};

/*!	\class	DateHourMinControl
 *	\brief	This class unifies two other classes into one entity.
 */
class DateHourMinControl :
	public CalendarControl,
	public HourMinControl
{
	protected:
	
	
	public:
		DateHourMinControl( BRect frame,
							const char* name,
...
};	// <-- end of class DateHourMinControl
