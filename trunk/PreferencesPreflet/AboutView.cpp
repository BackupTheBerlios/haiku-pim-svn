			 ...
			 B_WILL_DRAW | B_FRAME_EVENTS )
{
	...
	if ( urlViewToAdd )
	{
		...
		layoutItem = gridLayout->AddView( urlViewToAdd, 0, 0, 3, 1 );
		if ( layoutItem ) {
...
//		urlViewToAdd->SetHoverColor( 0, 0, 255 );
	...
	if ( stringViewToAdd )
	{
		...
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 1, 3, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	if ( stringViewToAdd )
	{
		...
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 2, 3, 1 );
		if ( layoutItem ) {
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 3, 1, 1 );
		if ( layoutItem ) {
	...
	if ( urlViewToAdd )
	{
		...
		urlViewToAdd->AddAttribute( "META:country", "Israel" );
		layoutItem = gridLayout->AddView( urlViewToAdd, 1, 3, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 4, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_RIGHT, B_ALIGN_TOP ) );
		}
	}
	...
	if ( urlViewToAdd )
	{
		...
		urlViewToAdd->AddAttribute( "META:country", "Israel" );
		layoutItem = gridLayout->AddView( urlViewToAdd, 1, 4, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 5, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_RIGHT, B_ALIGN_TOP ) );
		}
	}
	...
	if ( urlViewToAdd )
	{
		...
		layoutItem = gridLayout->AddView( urlViewToAdd, 1, 5, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 6, 3, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_CENTER, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 7, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_RIGHT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 1, 7, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 8, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_RIGHT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 1, 8, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	if ( urlViewToAdd )
	{
		...
		layoutItem = gridLayout->AddView( urlViewToAdd, 2, 8, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 9, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_RIGHT, B_ALIGN_TOP ) );
		}
	}
	stringViewToAdd = new BStringView( BRect( 0, 0, 1, 1 ),
												"additional thanks 3 - for",
												"for \"IconMenuItem\" and \"IconListItem\"" );
	if ( stringViewToAdd )
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 1, 9, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 10, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_RIGHT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 1, 10, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	if ( urlViewToAdd )
	{
		...
		layoutItem = gridLayout->AddView( urlViewToAdd, 2, 10, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 0, 11, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_RIGHT, B_ALIGN_TOP ) );
		}
	}
	...
	{
		stringViewToAdd->ResizeToPreferred();
		layoutItem = gridLayout->AddView( stringViewToAdd, 1, 11, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
	...
	if ( urlViewToAdd )
	{
		...
		layoutItem = gridLayout->AddView( urlViewToAdd, 2, 11, 1, 1 );
		if ( layoutItem ) {
			layoutItem->SetExplicitAlignment( BAlignment( B_ALIGN_LEFT, B_ALIGN_TOP ) );
		}
	}
